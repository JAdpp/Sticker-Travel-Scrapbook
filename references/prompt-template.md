...
Visual style:
[Write route-specific rendering language. Examples: cute sticker comic with light manga diary details; black-and-white cartoon doodle with thick marker lines, simple icons, and no grey wash; map infographic with numbered memory stops; polaroid photo collage with taped instant-photo frames. Keep East Asian 手帐 collage cues: white-border slots, washi tape, torn paper, grid/notebook paper, stamp marks, handwritten labels, and high-density but legible composition.]
